...
use pactmesh::common::config::{ConfigLoader, NetworkIdentity, TomlConfigLoader};
use pactmesh::common::error::Error;
use pactmesh::common::global_ctx::{GlobalCtx, NetworkIdentity as GlobalNetworkIdentity};
use pactmesh::common::trust_context::TrustDomainContext;
use pactmesh::peers::create_packet_recv_chan;
use pactmesh::peers::foreign_network_manager::{
    ForeignNetworkManager, GlobalForeignNetworkAccessor,
};
use pactmesh::peers::peer_conn::PeerConn;
use pactmesh::peers::peer_session::PeerSessionStore;
use pactmesh::proto::common::SecureModeConfig;
use pactmesh::proto::peer_rpc::{PeerConnNoiseMsg1Pb, PeerConnNoiseMsg2Pb, PeerConnNoiseMsg3Pb};
use pactmesh::trust::{
...
use pactmesh::tunnel::packet_def::{PacketType, ZCPacket};
use pactmesh::tunnel::ring::create_ring_tunnel_pair;
use prost::Message;
use rand::rngs::OsRng;
...
async fn run_noise_client_with_proof(
    client_tunnel: Box<dyn pactmesh::tunnel::Tunnel>,
    client_peer_id: u32,
    server_peer_id: u32,
    network_name: &str,
